...
EXCLUSIONS_LIST=(
  ...
  apps/idam-api/preview.yaml
  apps/idam-api/sbox.yaml
  apps/idam-web-admin/preview.yaml
  apps/idam-web-admin/sbox.yaml
  apps/idam-web-public/preview.yaml
  apps/idam-web-public/sbox.yaml
)
